...
> "For validation, I wrote 239 unit tests covering all core modules.
>
...
> - 6 tactical rules, 7 action classes, 239 tests passing.
>
...
*핵심은 숫자(15 fps, 10 cm, 239 tests, 635 patterns)와 이유(why rules not ML).*
