...
# ── 하도리듬 동작 레이블 (PDF + PPT 통합) ────────────────────────
MOVEMENT_LABELS: dict[str, dict] = {
    # 키: (한글명, 단축키, 입문/기술/응용 레벨)
    "ready":          {"ko": "준비 자세",      "key": "0", "level": "기본"},
    "squat":          {"ko": "스쿼트",         "key": "1", "level": "입문"},
    "side_step":      {"ko": "사이드스텝",     "key": "2", "level": "입문"},
    "lunge":          {"ko": "런지",           "key": "3", "level": "입문"},
    "back_lunge":     {"ko": "백런지",         "key": "4", "level": "입문"},
    "slide":          {"ko": "슬라이드",       "key": "5", "level": "입문"},
    "running_slide":  {"ko": "런닝슬라이드",   "key": "6", "level": "기술"},
    "burpee":         {"ko": "버피테스트",     "key": "7", "level": "기술"},
    "rhythm_box":     {"ko": "하도리듬박스",   "key": "8", "level": "응용"},
...
LABEL_COLORS: dict[str, tuple[int, int, int]] = {
    ...
    "side_step":     (255, 220, 0),
    "lunge":         (40,  180, 255),
    "back_lunge":    (100, 140, 255),
    "slide":         (0,   255, 160),
    "running_slide": (0,   255, 80),
    "burpee":        (200, 60,  255),
    "rhythm_box":    (255, 100, 50),
}
